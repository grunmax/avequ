% V.F.S. 4.0 (working body) --- built per the approved roadmap vfs_4p0_roadmap.
% VFS 4.0 body: Stage 0 (P0.0--P0.6), Stage I (P1.0--P1.2),
% Stage II (P2.1--P2.4), Stage III (P3.0--P3.4),
% Stage IV (P4.0--P4.4), Stage V (P5.0--P5.2); Part II: 4.0-H (H.1--H.4). XeLaTeX.
...
\normalsize Stage~0--IV complete; Stage~V complete\\
\normalsize P0.0--P5.2: relational chronos, exact recovery,\\
\normalsize fibered encounter, Gate mediation, non-fusing locking,\\
\normalsize junctions, non-Zeno, plural Lyapunov, moving communion;\\
\normalsize Part~II: 4.0-H hardening (H.1--H.4);\\
\normalsize Part~III: 4.1 complete; Part~IV: 4.2 two-way terminus complete (P$\Psi$.0--P$\Psi$.5)}
